# original by https://github.com/jcaw/talon_config/blob/70cfc9d1/games/hiss_map_scroll.py
import math
import threading
import time
    ...
    def _update_scroll(self):
        ...
        if gaze_found:
            ...
            gaze_angle = angle_from_north(
                GAMIDPOINT, (gaze_position.x, gaze_position.y)
            )
            # TODO: Maybe deadzone?
